...
@Schema(description = "打印订单详情信息")
public class FinPrintOrderDetailResp extends BaseDetailResp {
    ...
    @ExcelProperty(value = "状态(PENDING/CONFIRMED/PRINTING/COMPLETED/CANCELLED)")
