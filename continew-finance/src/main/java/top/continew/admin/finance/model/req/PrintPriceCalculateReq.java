 ...
 */
@Data
@Schema(description = "打印价格计算请求参数")
public class PrintPriceCalculateReq implements Serializable {
    ...
    @NotEmpty(message = "至少需要一个计算项")
    @Valid
    private List<PrintPriceItemReq> items;

    /**
     * 单项价格计算请求
     */
    @Data
    @Schema(description = "单项价格计算请求")
    public static class PrintPriceItemReq implements Serializable {
